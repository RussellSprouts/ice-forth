...
S_FILES=note.s bootstrap.s coroutines.s disassembler.s end.s neslib.s
...
out/bootstrap.bin: $(S_FILES) forth.inc
	...
	$(CC65)/ld65 --dbgfile out/debug.txt -C config out/note.o out/bootstrap.o out/coroutines.o out/disassembler.o out/neslib.o out/end.o -o out/bootstrap.bin

out/bootstrap.bin.h: out/bootstrap.bin
	xxd -i out/bootstrap.bin out/bootstrap.bin.h

out/6502: 6502.cpp 6502.h
	g++ -O2 -Wall -Wpedantic -Wsequence-point -std=c++11 6502.cpp -o out/6502

out/game.nes: out/bootstrap.bin bootstrap.f font.chr subroutines.f game.f done.f out/6502
