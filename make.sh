...
../cc65/bin/ca65 --cpu 6502x -g coroutines.s
../cc65/bin/ca65 --cpu 6502x -g disassembler.s
../cc65/bin/ca65 --cpu 6502x -g end.s
../cc65/bin/ld65 --dbgfile debug.txt -C config note.o bootstrap.o neslib.o coroutines.o disassembler.o end.o -o bootstrap.bin
